...
mysqli_query($con,"insert into tbltickets(ticketNo,fullName,emailId,address,city,state,ticketCategory,ticketSubject,ticketDescription,supportFile,priority) values('$tcno','$fname','$emailid','$address','$city','$state','$catt','$tsub','$tdesc','$doc1','$priority')");
...
<head>
  ...
  <title>OSIT Fix  | Create Ticket</title>
...
<input type="hidden" name="csrftoken" value="<?php echo htmlentities($_SESSION['token']); ?>" />
    <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" id="fullname" name="fullname" value="<?=$_SESSION["fullname"];?>" required class="form-control" readonly="">
              </div>
            </div>
            <div class="col-md-6">
               ...
               <div class="form-group">
                ...
                <input type="email" id="emailid" name="emailid" value="<?=$_SESSION["email"];?>" required class="form-control" readonly="">
              </div>
            </div>
          </div>
